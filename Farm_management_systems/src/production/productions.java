...
public class productions extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					productions frame = new productions();
	...
	public productions() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				production_entity pur = new production_entity();
				if(e.getSource()==btnNewButton) {
					pur.setProduction_name(pname.getText());
					pur.setQuantity(Double.parseDouble(quantity.getText()));
					pur.setUnit_price(Double.parseDouble(unit_price.getText()));
					pur.setProduction_date(purchase_date.getText());
//					pur.setUnit_price(Double.parseDouble(purchase_date.getText()));
		...
		JLabel lblNewLabel_1 = new JLabel("PRODUCTION");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 22));
		lblNewLabel_1.setBounds(541, 0, 181, 26);
		...
		JLabel lblPrisonDistrict_1_1_1 = new JLabel("Ptoduction date :");
